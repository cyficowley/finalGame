...
public class UnbreakableCharacteristic extends BlockCharacteristic // copy this example of a class for other materials
{
    Color color;
    static ArrayList<BufferedImage> imageArray = new ArrayList<BufferedImage>();
    public static boolean hasLoaded = false;
    int rand;
    public UnbreakableCharacteristic(Block block)
    ...
    {
        try{
            imageArray.add(toCompatibleImage(ImageIO.read(new File("res/images/unbreakable.png"))));
        } catch (IOException e) {}
