...
public class GrassCharacteristic extends BlockCharacteristic // copy this example of a class for other materials
{
	...
	{
		try{
			imageArray.add(toCompatibleImage(ImageIO.read(new File("res/images/grass_1.png"))));
			imageArray.add(rotate90(toCompatibleImage(ImageIO.read(new File("res/images/grass_1.png")))));
			imageArray.add(rotate180(toCompatibleImage(ImageIO.read(new File("res/images/grass_1.png")))));
			imageArray.add(rotate270(toCompatibleImage(ImageIO.read(new File("res/images/grass_1.png")))));
			imageArray.add(toCompatibleImage(ImageIO.read(new File("res/images/grass_2.png"))));
			imageArray.add(rotate90(toCompatibleImage(ImageIO.read(new File("res/images/grass_2.png")))));
			imageArray.add(rotate180(toCompatibleImage(ImageIO.read(new File("res/images/grass_2.png")))));
			imageArray.add(rotate270(toCompatibleImage(ImageIO.read(new File("res/images/grass_2.png")))));
			imageArray.add(toCompatibleImage(ImageIO.read(new File("res/images/grass_3.png"))));
			imageArray.add(rotate90(toCompatibleImage(ImageIO.read(new File("res/images/grass_3.png")))));
			imageArray.add(rotate180(toCompatibleImage(ImageIO.read(new File("res/images/grass_3.png")))));
			imageArray.add(rotate270(toCompatibleImage(ImageIO.read(new File("res/images/grass_3.png")))));
		} catch (IOException e) {}
