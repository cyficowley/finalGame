...
public class CollisionContainer
{
	...
	{	
		if(first)
		{
			...
			else if(one.type.equals("itemBlock") && two.type.equals("bullet") ||two.type.equals("itemBlock") && one.type.equals("bullet")){}
			...
			else if(one.collision(two))
			{
				...
				if(xCollision)
		        {
					...
					if(oneLesser)
					{
						...
						one.x -= deltaX * (Math.abs(one.xVelocity) / (Math.abs(one.xVelocity) + Math.abs(two.xVelocity +.0001)));
						two.x += deltaX * (Math.abs(two.xVelocity) / (Math.abs(one.xVelocity) + Math.abs(two.xVelocity +.0001)));
		        ...
		        else
		        {
		        	...
		        	if(oneLesser)
		        	{
		        		...
		        		one.y -= deltaY * (Math.abs(one.yVelocity) / (Math.abs(one.yVelocity) + Math.abs(two.yVelocity+.0001)));
		        		two.y += deltaY * (Math.abs(two.yVelocity) / (Math.abs(one.yVelocity) + Math.abs(two.yVelocity+.0001)));
