...
import finalGame.materialClasses.*;
...
public class Block extends MainObject//this is going to be the base block of the worlds, a crap ton of these will make up the world
{
	...
	public boolean collisionActive; // if it is possible for stuff to collide with this block;
	public Chunk containingChunk; // the chunk that contains this blocks
	public BlockCharacteristic characteristic;
	public ArrayList<TouchData> touched= new ArrayList<TouchData>(); // all the movingobjects touch
	...
	{ // run this method if you are setting the block to a differnt type like empty or stone or something
		...
		{
			characteristic = new UnbreakableCharacteristic(this);
		}
		// else if( type == 2)
		// {
