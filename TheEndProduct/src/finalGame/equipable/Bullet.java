...
import finalGame.enemies.EnemyBullet;
...
public class Bullet extends MovingObject
{
	...
	double hardness;
	Gun gun;
	public Bullet(double speed, boolean gravity, double diameter, double x, double y, double angle,double hardness, Gun gun)
	{
		super(x,y,diameter, diameter);
		this.gun = gun;
		this.gravity = gravity;
		this.hardness = hardness;
		xVelocity = speed * Math.cos(angle) + Screen.mc.xVelocity;
		yVelocity = speed * Math.sin(angle) + Screen.mc.yVelocity;
		this.type = "bullet";
	...
	public void collision()
	{
		...
		else if(touched.get(0).touched.type.equals("block"))
		{
			Screen.movingObjects.remove(this);
			gun.bullets.remove(this);
			((Block)touched.get(0).touched).characteristic.breakBlock(hardness);
		}
